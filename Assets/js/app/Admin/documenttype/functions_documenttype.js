...
/**
 * Función que se encarga de listar la tabla de tipos de documento
 */
function loadTable() {
  table = $("#table").DataTable({
    ...
    aServerSide: true,
    ajax: {
      url: "" + base_url + "/DocumentType/getDocumentTypes",
      dataSrc: "",
    },
    columns: [
      { data: "cont" },
    ...
    buttons: [
      ...
      },
      {
        ...
        title: "Reporte de tipos de documento en Excel",
      ...
      },
      {
        ...
        title: "Reporte de tipos de documento en CSV",
      ...
      },
      {
        ...
        title: "Reporte de tipos de documento en PDF",
...
async function saveData() {
  ...
  formSave.addEventListener("submit", (e) => {
    ...
    const url = base_url + "/Documenttype/setDocumentType";
  ...
  arrBtnDeleteItem.forEach((item) => {
    item.addEventListener("click", (e) => {
      ...
      document.getElementById("txtDelete").innerHTML =
        "¿Está seguro de eliminar el tipo de documento <strong>" +
        name +
        " </strong>?";
...
async function deleteData() {
  ...
  confirmDelete.addEventListener("click", (e) => {
    ...
    const url = base_url + "/Documenttype/deleteDocumentType";
    elementLoader.classList.remove("d-none");
    fetch(url, config)
      .then((response) => {
        if (!response.ok) {
...
/**
 * Función que carga los datos en el reporte del modal del tipo de documento
 */
function loadDocumentTypeReport() {
...
/**
 * Función que se encarga de mostrar el modal para actualizar los datos del tipo de documento
 */
...
/**
 * Función que actualiza los datos del tipo de documento enviándolos al servidor
 */
async function updateData() {
  ...
  formUpdate.addEventListener("submit", (e) => {
    ...
    const url = base_url + "/Documenttype/updateDocumentType";
    elementLoader.classList.remove("d-none");
    fetch(url, config)
      .then((response) => {
        if (!response.ok) {
