...
<head>
    ...
    <title><?= $data['page_title'] ?? 'Error de sistema' ?></title>
    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background: linear-gradient(135deg, rgba(35, 67, 106, 0.06), rgba(239, 68, 68, 0.04));
            min-height: 100vh;
            width: 100%;
            overflow-x: hidden;
            display: flex;
    ...
    <div class="error-container">
        ...
        <div class="content-box">
            <h1 class="error-title">
                <?= $data['page_title'] ?? 'Método no disponible' ?>
            </h1>
            <p class="error-message">
                <?= $data['page_description'] ?? 'Estamos haciendo mejoras en esta sección o el enlace que has usado es antiguo. Por favor, intenta de nuevo más tarde.' ?>
            </p>
