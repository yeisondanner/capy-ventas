...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="<?= media() ?>/css/libraries/Admin/toastr.min.css?<?= versionSystem() ?>">
    <link rel="stylesheet" type="text/css"
...
<body>
    ...
    <a target="_blank"
        href="https://wa.me/51910367611?text=Hola,%20tengo%20problemas%20con%20la%20recuperación%20de%20contraseña%20en%20Capy%20Ventas"
    ...
    <script type="module"
        src="<?= media() ?>/js/app/POS/resetpassword/functions_resetpassword_api.js?<?= versionSystem() ?>"></script>
    <script type="module"
        src="<?= media() ?>/js/app/POS/resetpassword/functions_resetpassword.js?<?= versionSystem() ?>"></script>
</body>
