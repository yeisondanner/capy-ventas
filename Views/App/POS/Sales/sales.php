...
<main class="app-content">
    ...
    <div class="row g-3 p-0 pos-layout align-items-stretch">
        <!-- PASO 1: Elegir producto -->
        <div class="col-12 col-lg-6 step-mobile pos-column" id="step1">
            <div class="card shadow-sm border-0 flex-fill pos-card">
        ...
        <div class="col-12 col-lg-3 step-mobile pos-column" id="step2">
            <div class="card shadow-sm border-0 flex-fill pos-card">
        ...
        <div class="col-12 col-lg-3 step-mobile pos-column" id="step3">
            <div class="card shadow-sm border-0 flex-fill pos-card">
                        <div class="card-header bg-white">
                            <div class="pos-step-title">
