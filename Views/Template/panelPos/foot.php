...
<script type="text/javascript" language="javascript"
    src="<?= media() ?>/js/libraries/POS/plugins/DataTables/v2.3.4/jquery.dataTables.min.js?<?= versionSystem() ?>"></script>
<script type="text/javascript" language="javascript"
    src="<?= media() ?>/js/libraries/POS/plugins/DataTables/v2.3.4/dataTables.min.js?<?= versionSystem() ?>"></script>

<!-- DataTables Bootstrap 5: Capa de integración para asegurar que las tablas y sus controles luzcan nativos de Bootstrap 5 -->
<script type="text/javascript" language="javascript"
    src="<?= media() ?>/js/libraries/POS/plugins/DataTables/v2.3.4/dataTables.bootstrap5.min.js?<?= versionSystem() ?>"></script>
...
<script type="text/javascript" language="javascript"
    src="<?= media() ?>/js/libraries/POS/plugins/AutoFill/v2.7.1/dataTables.autoFill.min.js?<?= versionSystem() ?>"></script>

<!-- ColReorder: Permite a los usuarios reorganizar dinámicamente el orden de las columnas de las tablas usando Drag & Drop -->
<script type="text/javascript" language="javascript"
    src="<?= media() ?>/js/libraries/POS/plugins/ColReorder/v2.1.2/dataTables.colReorder.min.js?<?= versionSystem() ?>"></script>
<!-- ColReorder Bootstrap 5: Capa de estilización para asegurar que el reordenamiento se vea bien en componentes Bootstrap 5 -->
<script type="text/javascript" language="javascript"
    src="<?= media() ?>/js/libraries/POS/plugins/ColReorder/v2.1.2/colReorder.bootstrap5.min.js?<?= versionSystem() ?>"></script>
<script type="text/javascript" language="javascript"
    src="<?= media() ?>/js/libraries/POS/plugins/Responsive/v3.0.8/dataTables.responsive.min.js?<?= versionSystem() ?>"></script>
<script type="text/javascript" language="javascript"
    src="<?= media() ?>/js/libraries/POS/plugins/Responsive/v3.0.8/responsive.bootstrap5.min.js?<?= versionSystem() ?>"></script>
...
<script type="text/javascript" language="javascript"
    src="<?= media() ?>/js/libraries/POS/plugins/Buttons/v3.2.6/dataTables.buttons.min.js?<?= versionSystem() ?>"></script>
...
<script type="text/javascript" language="javascript"
    src="<?= media() ?>/js/libraries/POS/plugins/Buttons/v3.2.6/buttons.html5.min.js?<?= versionSystem() ?>"></script>
...
<script type="text/javascript" language="javascript"
    src="<?= media() ?>/js/libraries/POS/plugins/JSZip/v3.10.1/jszip.min.js?<?= versionSystem() ?>"></script>
...
<script type="text/javascript" language="javascript"
    src="<?= media() ?>/js/libraries/POS/plugins/PDFMake/v0.1.36/pdfmake.min.js?<?= versionSystem() ?>"></script>
<script type="text/javascript" language="javascript"
    src="<?= media() ?>/js/libraries/POS/plugins/PDFMake/v0.1.36/vfs_fonts.js?<?= versionSystem() ?>"></script>
...
<script type="text/javascript" language="javascript"
    src="<?= media() ?>/js/libraries/POS/plugins/ChartJs/v4.3.0/chart.js?<?= versionSystem() ?>"></script>
...
<!-- Chart.js: Herramienta empleada para la visualización de datos estadísticos avanzados mediante distintos tipos de gráficas interactivas -->
<script type="text/javascript" language="javascript"
    src="<?= media() ?>/js/libraries/POS/plugins/ChartJs/v4.5.1/chart.umd.min.js?<?= versionSystem() ?>"></script>
...
<script type="text/javascript" language="javascript"
    src="<?= media() ?>/js/libraries/POS/plugins/Html2Canvas/v1.4.1/html2canvas.min.js?<?= versionSystem() ?>"></script>
