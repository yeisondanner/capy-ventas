            ...
            <div class="modal-body d-flex flex-column p-4 gap-3">
                <div class="d-flex justify-content-between align-items-start w-100">
                    <div>
                        ...
                        <p class="text-muted mb-0 small"><i class="bi bi-circle-fill text-success"></i> Caja 01 - Principal - <strong id="reloj"><?= date('H:i:s A'); ?></strong></p>
                    </div>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="row">
                        ...
                        <div class="card rounded-4 mb-2">
                            ...
                            <div class="card-body">
                                <div class="d-flex gap-2">
                                    <div class="flex-fill">
                                        <button id="btnOpenModalArqueoBox" class="btn btn-light border border-1 rounded-4 d-flex flex-column p-2 align-items-center bg-white w-100">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="modal-body d-flex flex-column p-4 gap-3">
                <div class="d-flex justify-content-between align-items-start w-100">
                    <div>
                        <h3 class="fw-bold mb-1">Arqueo de Caja</h3>
                        <p class="text-muted mb-0 small"><i class="bi bi-circle-fill text-success"></i> Caja 01 - Principal - <strong id="reloj_2"><?= date('H:i:s A'); ?></strong></p>
                    </div>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="row">
