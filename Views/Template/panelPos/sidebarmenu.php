...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <?php else: ?>
            <li><a class="app-menu__item <?= $data['page_id'] === 0 ? 'active' : '' ?>" href="<?= base_url() ?>/pos/dashboard"><i class="app-menu__icon bi bi-house-door"></i><span class="app-menu__label">Inicio</span></a></li>
            <li><a <?= $data_menu_employee(1) ? '' : 'style="cursor: no-drop;"' ?> class="app-menu__item <?= $data['page_id'] === 1 ? 'active' : '' ?>" href=" <?= $data_menu_employee(1) ? base_url() . '/pos/sales' : '' ?>"><i class="app-menu__icon bi bi-cart"></i><span class="app-menu__label"><?= $data_menu_employee(1) ? '' : '<span class="badge bg-danger text-white shadow"><i class="bi bi-ban"></i></span>' ?> <?= $data_menu_employee(1) ? $data_menu_employee(1)['Interface'] : 'Vender' ?></span></a></li>
            <li><a <?= $data_menu_employee(2) ? '' : 'style="cursor: no-drop;"' ?> class="app-menu__item <?= $data['page_id'] === 2 ? 'active' : '' ?>" href="<?= $data_menu_employee(2) ? base_url() . '/pos/movements' : '' ?>"><i class="app-menu__icon bi bi-pc-display-horizontal"></i><span class="app-menu__label"><?= $data_menu_employee(2) ? '' : '<span class="badge bg-danger text-white shadow"><i class="bi bi-ban"></i></span>' ?> <?= $data_menu_employee(2) ? $data_menu_employee(2)['Interface'] : 'Movimientos' ?></span></a></li>
            <li><a <?= $data_menu_employee(3) ? '' : 'style="cursor: no-drop;"' ?> class="app-menu__item <?= $data['page_id'] === 3 ? 'active' : '' ?>" href="<?= $data_menu_employee(3) ? base_url() . '/pos/inventory' : '' ?>"><i class="app-menu__icon bi bi-box-seam"></i><span class="app-menu__label"><?= $data_menu_employee(3) ? '' : '<span class="badge bg-danger text-white shadow"><i class="bi bi-ban"></i></span>' ?> <?= $data_menu_employee(3) ? $data_menu_employee(3)['Interface'] : 'Inventario' ?></span></a></li>
            <li><a <?= $data_menu_employee(4) ? '' : 'style="cursor: no-drop;"' ?> class="app-menu__item <?= $data['page_id'] === 4 ? 'active' : '' ?>" href="<?= $data_menu_employee(4) ? base_url() . '/pos/customers' : '' ?>"><i class="app-menu__icon bi bi-person-lines-fill"></i><span class="app-menu__label"><?= $data_menu_employee(4) ? '' : '<span class="badge bg-danger text-white shadow"><i class="bi bi-ban"></i></span>' ?> <?= $data_menu_employee(4) ? $data_menu_employee(4)['Interface'] : 'Clientes' ?></span></a></li>
            <li><a <?= $data_menu_employee(7) ? '' : 'style="cursor: no-drop;"' ?> class="app-menu__item <?= $data['page_id'] === 7 ? 'active' : '' ?>" href="<?= $data_menu_employee(7) ? base_url() . '/pos/suppliers' : '' ?>"><i class="app-menu__icon bi bi-people"></i><span class="app-menu__label"><?= $data_menu_employee(7) ? '' : '<span class="badge bg-danger text-white shadow"><i class="bi bi-ban"></i></span>' ?> <?= $data_menu_employee(7) ? $data_menu_employee(7)['Interface'] : 'Proveedores' ?></span></a></li>
            <li><a <?= $data_menu_employee(5) ? '' : 'style="cursor: no-drop;"' ?> class="app-menu__item <?= $data['page_id'] === 5 ? 'active' : '' ?>" href="<?= $data_menu_employee(5) ? base_url() . '/pos/employee' : '' ?>"><i class="app-menu__icon bi bi-people"></i><span class="app-menu__label"><?= $data_menu_employee(5) ? '' : '<span class="badge bg-danger text-white shadow"><i class="bi bi-ban"></i></span>' ?> <?= $data_menu_employee(5) ? $data_menu_employee(5)['Interface'] : 'Empleados' ?></span></a></li>
            <li><a <?= $data_menu_employee(6) ? '' : 'style="cursor: no-drop;"' ?> class="app-menu__item <?= $data['page_id'] === 6 ? 'active' : '' ?>" href="<?= $data_menu_employee(6) ? base_url() . '/pos/roles' : '' ?>"><i class="app-menu__icon bi bi-shield-check"></i><span class="app-menu__label"><?= $data_menu_employee(6) ? '' : '<span class="badge bg-danger text-white shadow"><i class="bi bi-ban"></i></span>' ?> <?= $data_menu_employee(6) ? $data_menu(6)['Interface'] : 'Roles' ?></span></a></li>
