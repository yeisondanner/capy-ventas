...
<aside class="app-sidebar">
    <div class="app-sidebar__user">
        <img class="app-sidebar__user-avatar" src="<?= GENERAR_PERFIL ?><?= $_SESSION[$nameVarLoginInfo]['name'] ?>"
            alt="User Image">
        <div>
        ...
        <div class="card shadow-sm" style="max-width: 280px;">
            <div class="card-body">
                <div class="d-flex align-items-center gap-1">
                    <!-- Avatar -->
                    <img class="app-sidebar__user-avatar p-0 m-0" id="currentBusinessAvatar" src="<?= $logoBusiness ?>"
                        alt="User Image">
                    <!-- Nombre y rol -->
                    <div class="flex-grow-1">
                        <div class="fw-semibold" id="currentBusinessName">
                            <?= htmlspecialchars($_SESSION[$nameVarBusiness]['business'] ?? 'Negocio', ENT_QUOTES, 'UTF-8'); ?>
                        </div>
                        <div class="text-muted small" id="currentBusinessCategory">
                            <?= htmlspecialchars($_SESSION[$nameVarBusiness]['category'] ?? 'Propietario', ENT_QUOTES, 'UTF-8'); ?>
                        </div>
                    </div>
                    <!-- Caret / Dropdown selector -->
                    <div class="dropdown ms-auto">
                        <button class="btn btn-link p-0 text-secondary" id="businessDropdownBtn"
                            data-bs-toggle="dropdown" aria-expanded="false" aria-label="Seleccionar negocio">
                            <i class="bi bi-chevron-down"></i>
                        </button>
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="businessDropdownBtn"
                            id="businessListDropdown">
    ...
    <ul class="app-menu">
        <?php if (!isset($_SESSION[$nameVarPermissionEmployee])): ?>
            <li><a class="app-menu__item <?= $data['page_id'] === 0 ? 'active' : '' ?>"
                    href="<?= base_url() ?>/pos/dashboard"><i class="app-menu__icon bi bi-house-door"></i><span
                        class="app-menu__label">Inicio</span></a></li>
            <li><a class="app-menu__item <?= $data['page_id'] === 1 ? 'active' : '' ?>"
                    href=" <?= $data_menu(1) ? base_url() . '/pos/sales' : $linkestadointerfaz ?>"><i
            ...
            <li><a class="app-menu__item <?= ($data['page_id'] === 2 || $data['page_id'] === 12) ? 'active' : '' ?>"
                    href="<?= $data_menu(2) ? base_url() . '/pos/movements' : $linkestadointerfaz ?>"><i
                        ...
                        <?= $data_menu(2) ? $data_menu(2)['Interface'] : 'Movimientos' ?></span></a></li>
            <li><a class="app-menu__item <?= $data['page_id'] === 9 ? 'active' : '' ?>"
                    href="<?= $data_menu(9) ? base_url() . '/pos/movements' : $linkestadointerfaz ?>"><i
                        class="app-menu__icon bi bi-bar-chart-line"></i><span
                        class="app-menu__label"><?= $data_menu(9) ? '' : '<span class="badge bg-success text-white shadow"><i class="bi bi-arrow-up"></i> Mejorar</span>' ?>
                        <?= $data_menu(9) ? $data_menu(9)['Interface'] : 'Estadisticas' ?></span></a></li>
            <li><a class="app-menu__item <?= $data['page_id'] === 3 ? 'active' : '' ?>"
                    href="<?= $data_menu(3) ? base_url() . '/pos/inventory' : $linkestadointerfaz ?>"><i
                        class="app-menu__icon bi bi-box-seam"></i><span
                        class="app-menu__label"><?= $data_menu(3) ? '' : '<span class="badge bg-success text-white shadow"><i class="bi bi-arrow-up"></i> Mejorar</span>' ?>
                        <?= $data_menu(3) ? $data_menu(3)['Interface'] : 'Inventario' ?></span></a></li>
            <li><a class="app-menu__item <?= $data['page_id'] === 4 ? 'active' : '' ?>"
                    href="<?= $data_menu(4) ? base_url() . '/pos/customers' : $linkestadointerfaz ?>"><i
                        class="app-menu__icon bi bi-person-lines-fill"></i><span
                        class="app-menu__label"><?= $data_menu(4) ? '' : '<span class="badge bg-success text-white shadow"><i class="bi bi-arrow-up"></i> Mejorar</span>' ?>
                        <?= $data_menu(4) ? $data_menu(4)['Interface'] : 'Clientes' ?></span></a></li>
            <li><a class="app-menu__item <?= $data['page_id'] === 7 ? 'active' : '' ?>"
                    href="<?= $data_menu(7) ? base_url() . '/pos/suppliers' : $linkestadointerfaz ?>"><i
                        class="app-menu__icon bi bi-people"></i><span
                        class="app-menu__label"><?= $data_menu(7) ? '' : '<span class="badge bg-success text-white shadow"><i class="bi bi-arrow-up"></i> Mejorar</span>' ?>
                        <?= $data_menu(7) ? $data_menu(7)['Interface'] : 'Proveedores' ?></span></a></li>
            <li><a class="app-menu__item <?= $data['page_id'] === 5 ? 'active' : '' ?>"
                    href="<?= $data_menu(5) ? base_url() . '/pos/employee' : $linkestadointerfaz ?>"><i
                        class="app-menu__icon bi bi-people"></i><span
                        class="app-menu__label"><?= $data_menu(5) ? '' : '<span class="badge bg-success text-white shadow"><i class="bi bi-arrow-up"></i> Mejorar</span>' ?>
                        <?= $data_menu(5) ? $data_menu(5)['Interface'] : 'Empleados' ?></span></a></li>
            <li><a class="app-menu__item <?= $data['page_id'] === 6 ? 'active' : '' ?>"
                    href="<?= $data_menu(6) ? base_url() . '/pos/roles' : $linkestadointerfaz ?>"><i
        ...
        <?php else: ?>
            ...
            <?php if ($data_menu_employee(1)): ?>
                <li>
                    <a <?= $data_menu_employee(1) ? '' : 'style="cursor: no-drop;"' ?>
                        class="app-menu__item <?= $data['page_id'] === 1 ? 'active' : '' ?>"
                        href=" <?= $data_menu_employee(1) ? base_url() . '/pos/sales' : base_url() . '/pos/Errors/no_permisos' ?>">
                        <i class="app-menu__icon bi bi-cart"></i>
                        <span
                            class="app-menu__label"><?= $data_menu_employee(1) ? $data_menu_employee(1)['Interface'] : 'Vender' ?></span>
                    </a>
                </li>
            <?php endif; ?>
            <?php if ($data_menu_employee(2)): ?>
                <li>
                    <a <?= $data_menu_employee(2) ? '' : 'style="cursor: no-drop;"' ?>
                        ...
                        <span
                            class="app-menu__label"><?= $data_menu_employee(2) ? $data_menu_employee(2)['Interface'] : 'Movimientos' ?></span>
                    </a>
                </li>
            <?php endif; ?>
            <?php if ($data_menu_employee(9)): ?>
                <li>
                    <a <?= $data_menu_employee(9) ? '' : 'style="cursor: no-drop;"' ?>
                        class="app-menu__item <?= $data['page_id'] === 9 ? 'active' : '' ?>"
                        href="<?= $data_menu_employee(9) ? base_url() . '/pos/movements' : base_url() . '/pos/Errors/no_permisos' ?>">
                        <i class="app-menu__icon bi bi-bar-chart-line"></i>
                        <span
                            class="app-menu__label"><?= $data_menu_employee(9) ? $data_menu_employee(9)['Interface'] : 'Estadisticas' ?></span>
                    </a>
                </li>
            <?php endif; ?>
            <?php if ($data_menu_employee(3)): ?>
                <li>
                    <a <?= $data_menu_employee(3) ? '' : 'style="cursor: no-drop;"' ?>
                        class="app-menu__item <?= $data['page_id'] === 3 ? 'active' : '' ?>"
                        href="<?= $data_menu_employee(3) ? base_url() . '/pos/inventory' : base_url() . '/pos/Errors/no_permisos' ?>">
                        <i class="app-menu__icon bi bi-box-seam"></i>
                        <span
                            class="app-menu__label"><?= $data_menu_employee(3) ? $data_menu_employee(3)['Interface'] : 'Inventario' ?></span>
                    </a>
                </li>
            <?php endif; ?>
            <?php if ($data_menu_employee(4)): ?>
                <li>
                    <a <?= $data_menu_employee(4) ? '' : 'style="cursor: no-drop;"' ?>
                        class="app-menu__item <?= $data['page_id'] === 4 ? 'active' : '' ?>"
                        href="<?= $data_menu_employee(4) ? base_url() . '/pos/customers' : base_url() . '/pos/Errors/no_permisos' ?>">
                        <i class="app-menu__icon bi bi-person-lines-fill"></i>
                        <span
                            class="app-menu__label"><?= $data_menu_employee(4) ? $data_menu_employee(4)['Interface'] : 'Clientes' ?></span>
                    </a>
                </li>
            <?php endif; ?>
            <?php if ($data_menu_employee(7)): ?>
                <li>
                    <a <?= $data_menu_employee(7) ? '' : 'style="cursor: no-drop;"' ?>
                        class="app-menu__item <?= $data['page_id'] === 7 ? 'active' : '' ?>"
                        href="<?= $data_menu_employee(7) ? base_url() . '/pos/suppliers' : base_url() . '/pos/Errors/no_permisos' ?>">
                        <i class="app-menu__icon bi bi-people"></i>
                        <span
                            class="app-menu__label"><?= $data_menu_employee(7) ? $data_menu_employee(7)['Interface'] : 'Proveedores' ?></span>
                    </a>
                </li>
            <?php endif; ?>
            <?php if ($data_menu_employee(5)): ?>
                <li>
                    <a <?= $data_menu_employee(5) ? '' : 'style="cursor: no-drop;"' ?>
                        class="app-menu__item <?= $data['page_id'] === 5 ? 'active' : '' ?>"
                        href="<?= $data_menu_employee(5) ? base_url() . '/pos/employee' : base_url() . '/pos/Errors/no_permisos' ?>">
                        <i class="app-menu__icon bi bi-people"></i>
                        <span
                            class="app-menu__label"><?= $data_menu_employee(5) ? $data_menu_employee(5)['Interface'] : 'Empleados' ?></span>
                    </a>
                </li>
            <?php endif; ?>
            <?php if ($data_menu_employee(6)): ?>
                <li>
                    <a <?= $data_menu_employee(6) ? '' : 'style="cursor: no-drop;"' ?>
                        class="app-menu__item <?= $data['page_id'] === 6 ? 'active' : '' ?>"
                        href="<?= $data_menu_employee(6) ? base_url() . '/pos/roles' : base_url() . '/pos/Errors/no_permisos' ?>">
                        <i class="app-menu__icon bi bi-shield-check"></i>
                        <span
                            class="app-menu__label"><?= $data_menu_employee(6) ? $data_menu_employee(6)['Interface'] : 'Roles' ?></span>
                    </a>
                </li>
            <?php endif; ?>
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <form class="modal-content" id="formAddBusiness" autocomplete="off">
            ...
            <div class="modal-body">
                ...
                <div class="row g-3">
                    <div class="col-6 col-md-3">
                        <label for="businessType" class="form-label">Tipo de negocio <span
                    ...
                    <div class="col-6 col-md-3">
                        <label for="businessDocument" class="form-label">Número de documento <span
                                class="text-danger">*</span></label>
                        <div class="input-group">
                    ...
                    <div class="col-12 col-md-6">
                        <label for="businessName" class="form-label">Nombre del negocio <span
                                class="text-danger">*</span></label>
                        <div class="input-group">
                            <span class="input-group-text"><i class="bi bi-shop"></i></span>
                            <input type="text" class="form-control" id="businessName" name="businessName"
                                maxlength="255" required placeholder="Ingresa el nombre comercial">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <label for="businessEmail" class="form-label">Correo electrónico <span
                                class="text-danger">*</span></label>
                        <div class="input-group">
                            <span class="input-group-text"><i class="bi bi-envelope"></i></span>
                            <input type="email" class="form-control" id="businessEmail" name="businessEmail"
                                maxlength="255" required placeholder="correo@ejemplo.com">
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-2">
                        <label for="businessTelephonePrefix" class="form-label">Prefijo telefónico <span
                                class="text-danger">*</span></label>
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="businessTelephonePrefix"
                                name="businessTelephonePrefix" maxlength="7" required placeholder="+51" value="+51">
                        </div>
                    </div>
                    <div class="col-md-5">
                        <label for="businessPhone" class="form-label">Teléfono <span
                                class="text-danger">*</span></label>
                        <div class="input-group">
                            <span class="input-group-text"><i class="bi bi-telephone"></i></span>
                            <input type="text" class="form-control" id="businessPhone" name="businessPhone"
                                maxlength="11" required placeholder="Número de contacto">
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="businessDirection"
                                onkeyup="this.value = this.value.toUpperCase()" name="businessDirection"
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="btnAddBusiness"><i class="bi bi-save"></i> Guardar
                    negocio</button>
            </div>
        </form>
    </div>
